...
The SSS Operations Portal is a Streamlit-based business application for Swift-hands Student Services. It supports employee registration, assignment allocation, quality control, payroll processing, financial planning, automated archiving, and WhatsApp notifications.

## Features

*   **Role-Based Access**: Controlled access for administrators and employees.
*   **Administration Dashboard**:
    *   Register employees and maintain skills profiles.
    *   Create assignments and allocate work manually or automatically.
    *   Review completed and cancelled assignments through quality control.
    *   Approve assignments and manage payroll processing.
    *   Preview employee dashboards for support and oversight.
*   **Employee Dashboard**:
    *   Review, confirm, start, complete, or withdraw from assignments.
    *   Maintain areas of expertise and monitor performance points.
    *   Review earnings, pending payments, and assignment history.
*   **Financial Planning**: Corporate financial modelling for compensation, billing, payroll, revenue, and profitability.
*   **Automated Archiving**: Periodic archival of completed assignment records for audit purposes.
*   **WhatsApp Notification Service**:
    *   Notifies employees of new assignments and scheduled reminders.
    *   Alerts administrators to cancellations and completed assignments requiring review.
    *   Integrated with Meta's official WhatsApp Cloud API.

## Setup

Follow these steps to configure and run the SSS Operations Portal.
...
1.  **Create a Google Sheet**: Create a new Google Sheet in your Google Drive. This sheet stores employee, assignment, settings, and accounting data. The default URL is:
